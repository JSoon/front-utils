...
(function (global2, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.utils = {}));
    ...
    !function (t, s) {
      ...
      var t,
        ...
        function l2(t2, s2, n2) {
          ...
          if ("object" == _typeof(t2)) return Object.keys(t2).forEach(function (s3) {
            i2.$d[m(s3)] = t2[s3];
        ...
        return y2.calMilliseconds = function () {
          ...
          var t2 = g(this.$d.years, "Y"),
              s2 = g(this.$d.months, "M"),
              n2 = +this.$d.days || 0;
          this.$d.weeks && (n2 += 7 * this.$d.weeks);
          var i2 = g(n2, "D"),
              e2 = g(this.$d.hours, "H"),
              r2 = g(this.$d.minutes, "M"),
              o2 = this.$d.seconds || 0;
          this.$d.milliseconds && (o2 += this.$d.milliseconds / 1e3);
          var u2 = g(o2, "S"),
              h2 = t2.negative || s2.negative || i2.negative || e2.negative || r2.negative || u2.negative,
              a2 = e2.format || r2.format || u2.format ? "T" : "",
              d2 = (h2 ? "-" : "") + "P" + t2.format + s2.format + i2.format + a2 + e2.format + r2.format + u2.format;
  ...
  function formatMilliseconds(ms) {
    ...
    var hours = d.hours() ? "".concat(d.hours(), "\u5C0F\u65F6") : "";
    var days = d.days() ? "".concat(d.days(), "\u5929") : "";
    if (ms < 1e3) return "".concat(ms, "\u6BEB\u79D2");
    if (ms < 60 * 1e3) return "".concat(seconds);
    if (ms < 60 * 60 * 1e3) return "".concat(minutes).concat(seconds);
    if (ms < 24 * 60 * 60 * 1e3) return "".concat(hours).concat(minutes).concat(seconds);
  ...
  function getFlatObjectArray(nestedArray) {
    var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "children";

    var getItems = function getItems(item) {
      var _a;

      var copiedItem = lodash.exports.cloneDeep(item);
      delete copiedItem[key];

      if (!((_a = item[key]) == null ? void 0 : _a.length)) {
        return copiedItem;
      }

      return [copiedItem, lodash.exports.flatMapDeep(item[key], getItems)];
    };

    return lodash.exports.flatMapDeep(nestedArray, getItems);
  }
